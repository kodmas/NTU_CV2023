...
def plot_learning_curve(logfile_dir, result_lists):
    ...
    plt.plot(result_lists['train_acc'].cpu(),label='train_acc')
    plt.legend()
    fname = os.path.join(logfile_dir,'train_acc.png')
    plt.savefig(fname)
    ...
    plt.ylabel = 'acc'
    plt.grid()
   # plt.plot(result_lists['val_acc'],label='valid_acc')
    plt.plot(result_lists['val_acc'].cpu(),label='valid_acc')
    plt.legend()
    fname = os.path.join(logfile_dir,'valid_acc.png')
    plt.savefig(fname)
    ...
    plt.plot(result_lists['train_loss'].cpu(),label='train_loss')
    plt.legend()
    fname = os.path.join(logfile_dir,'train_loss.png')
    plt.savefig(fname)
    ...
    plt.ylabel = 'loss'
    plt.grid()
    #plt.plot(result_lists['val_loss'],label='valid_loss')
    plt.plot(result_lists['val_loss'].cpu(),label='valid_loss')
    plt.legend()
    fname = os.path.join(logfile_dir,'valid_loss.png')
    plt.savefig(fname)
